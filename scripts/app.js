...
const CASES = [
  {
    ...
    path: "./example/Matrix Rain 2.0/index.html",
    promotPath: "./example/Matrix Rain 2.0/promot.md",
  ...
  },
  {
    ...
    path: "./example/Neon button with CSS/index.html",
    promotPath: "./example/Neon button with CSS/promot.md",
  ...
  },
  {
    ...
    path: "./example/SharpGlowingdarkcard/index.html",
    promotPath: "./example/SharpGlowingdarkcard/promot.md",
  ...
  },
  {
    ...
    path: "./example/Trail/index.html",
    promotPath: "./example/Trail/promot.md",
    folder: "Trail",
    color: "#eeeeee",
